 ...
 * Materiel
 *
 * @ORM\Table(name="materiel", indexes={@ORM\Index(name="idStatut", columns={"idStatut"}), @ORM\Index(name="idSpecificite", columns={"idSpecificite"}), @ORM\Index(name="idLieu", columns={"idLieu"}), @ORM\Index(name="idUser", columns={"idUser"}), @ORM\Index(name="idType", columns={"idType"}), @ORM\Index(name="idMarque", columns={"idMarque"})})
 * @ORM\Entity
 */
class Materiel
{
