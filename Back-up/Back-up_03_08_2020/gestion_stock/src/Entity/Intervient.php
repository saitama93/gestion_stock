 ...
 * Intervient
 *
 * @ORM\Table(name="intervient", indexes={@ORM\Index(name="idStatut", columns={"idStatut"}), @ORM\Index(name="idMateriel", columns={"idMateriel"}), @ORM\Index(name="idLieu", columns={"idLieu"}), @ORM\Index(name="IDX_3F111A398F86B05A", columns={"idIntervention"})})
 * @ORM\Entity
 */
class Intervient
{
