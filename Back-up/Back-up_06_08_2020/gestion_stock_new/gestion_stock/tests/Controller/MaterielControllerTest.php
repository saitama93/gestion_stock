...
class MaterielControllerTest extends WebTestCase
{
    ...
    public function testEdit(){
        ...
        $client->request('GET','/stock/edit/2');
        $this->assertEquals(200,$client->getResponse()->getStatusCode());
    }
    public function testDelete(){
        ...
        $client->request('GET','/stock/delete/2');
        $this->assertEquals(200,$client->getResponse()->getStatusCode());
    }
    public function testDeleteMultiple(){
        ...
        $client->request('GET','/stock/deleteMultiple');
        $this->assertEquals(200,$client->getResponse()->getStatusCode());
    }
    ...
    public function testDowloadModel(){
        ...
        $client->request('GET','/stock/downloadModel');
        $this->assertEquals(500,$client->getResponse()->getStatusCode());
    }
